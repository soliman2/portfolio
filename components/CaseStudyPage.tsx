                ...
                >
                    ...
                    >
                        <div className="rounded-xl overflow-hidden bg-slate-100 aspect-[4/3] relative">
                             {/* Placeholder for HERO_SCREENSHOT_MAIN */}
                             <img 
        ...
        <section className="py-24 bg-[#1A1D23] text-white">
            <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    {[
                        "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=2070&auto=format&fit=crop", // Upload
                        "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?q=80&w=2070&auto=format&fit=crop", // Style
                        "https://images.unsplash.com/photo-1664575602554-2087b04935a5?q=80&w=2160&auto=format&fit=crop", // Generate
                        "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=1964&auto=format&fit=crop"  // Export
                    ].map((img, i) => (
        ...
        <section className="py-24 bg-[#1A1D23] text-white overflow-hidden">
            <div className="max-w-[1200px] mx-auto px-6 lg:px-8 space-y-24">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    >
                        <img 
                            src="https://images.unsplash.com/photo-1620712943543-bcc4688e7485?q=80&w=2160&auto=format&fit=crop" 
                            alt="Comparison View" 
            ...
            <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[
                        ...
                        "https://images.unsplash.com/photo-1531482615713-2afd69097998?q=80&w=2070&auto=format&fit=crop", // Workshop
                        "https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=2070&auto=format&fit=crop", // Presentation
                        "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?q=80&w=2032&auto=format&fit=crop", // Discussion
                        "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?q=80&w=2070&auto=format&fit=crop", // Office
                        "https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=2070&auto=format&fit=crop"  // Team
                    ].map((src, i) => (
                        <div key={i} className="group relative rounded-xl overflow-hidden aspect-[4/3] border border-white/10">
                            <img src={src} alt="Real World" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-80 group-hover:opacity-100" />
