...
import { 
  ArrowLeft, Shirt, Droplets, Waves, ClipboardList, Users, Search, 
  ...
  return (
    <div className="bg-white w-full overflow-hidden text-[#1A1D23] font-sans selection:bg-[#06B6D4] selection:text-white">
        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-8 py-6">
            <button 
                onClick={onBack}
                className="group inline-flex items-center gap-2 text-slate-500 hover:text-[#06B6D4] transition-colors font-medium text-sm"
            >
        ...
        <section className="py-24 bg-[#1A1D23] text-white text-center">
             <div className="max-w-[800px] mx-auto px-6 lg:px-8">
                 ...
                 <div className="flex flex-col md:flex-row justify-center gap-4">
                     <button 
                        onClick={onBack}
                        className="px-8 py-4 bg-white text-[#1A1D23] font-bold rounded-full hover:bg-slate-200 transition-colors"
                     >
                        Back to Portfolio
                     </button>
                 </div>
